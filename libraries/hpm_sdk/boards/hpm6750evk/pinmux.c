...
void init_gptmr_pins(GPTMR_Type *ptr)
{
    if (ptr == HPM_GPTMR0) {
        /* TMR0 capture 0 */
        HPM_IOC->PAD[IOC_PAD_PA15].FUNC_CTL = 1;
        /* TMR0 capture 1 */
        HPM_IOC->PAD[IOC_PAD_PA14].FUNC_CTL = 1;
    }
}
...
{
    HPM_IOC->PAD[IOC_PAD_PF04].FUNC_CTL = IOC_PF04_FUNC_CTL_PDM0_CLK;
    HPM_IOC->PAD[IOC_PAD_PF01].FUNC_CTL = IOC_PF01_FUNC_CTL_PDM0_D_0;
    HPM_IOC->PAD[IOC_PAD_PF00].FUNC_CTL = IOC_PF00_FUNC_CTL_PDM0_D_1;
    HPM_IOC->PAD[IOC_PAD_PF03].FUNC_CTL = IOC_PF03_FUNC_CTL_PDM0_D_2;
    HPM_IOC->PAD[IOC_PAD_PF02].FUNC_CTL = IOC_PF02_FUNC_CTL_PDM0_D_3;
}
...
void init_enet_pins(ENET_Type *ptr)
{
    if (ptr == HPM_ENET0) {
        ...
        /* Use an internal clock as the reference clock */
...
{
    HPM_IOC->PAD[IOC_PAD_PE14].FUNC_CTL = IOC_PAD_FUNC_CTL_ANALOG_MASK;
