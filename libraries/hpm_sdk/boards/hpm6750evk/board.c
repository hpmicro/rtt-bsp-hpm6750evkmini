...
void board_init_usb_pins(void)
{
    ...
    /* set USBx VBUS signals to low level */
    gpio_write_pin(BOARD_USB0_VBUS_PORT, BOARD_USB0_VBUS_GPIO_INDEX, BOARD_USB0_VBUS_GPIO_PIN, 0);
    gpio_write_pin(BOARD_USB1_VBUS_PORT, BOARD_USB1_VBUS_GPIO_INDEX, BOARD_USB1_VBUS_GPIO_PIN, 0);

    /* configure USBx VBUS pins as output function */
    gpio_enable_pin_output(BOARD_USB0_VBUS_PORT, BOARD_USB0_VBUS_GPIO_INDEX, BOARD_USB0_VBUS_GPIO_PIN);
    gpio_enable_pin_output(BOARD_USB1_VBUS_PORT, BOARD_USB1_VBUS_GPIO_INDEX, BOARD_USB1_VBUS_GPIO_PIN);
}

void board_usb_vbus_ctrl(uint8_t usb_index, uint8_t level)
{
    if (usb_index == 0) {
        gpio_write_pin(BOARD_USB0_VBUS_PORT, BOARD_USB0_VBUS_GPIO_INDEX, BOARD_USB0_VBUS_GPIO_PIN, level);
    } else {
        gpio_write_pin(BOARD_USB1_VBUS_PORT, BOARD_USB1_VBUS_GPIO_INDEX, BOARD_USB1_VBUS_GPIO_PIN, level);
    }
}
