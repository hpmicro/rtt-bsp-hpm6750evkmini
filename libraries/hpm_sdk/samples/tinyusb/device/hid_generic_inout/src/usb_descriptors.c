...
tusb_desc_device_t const desc_device =
{
    ...
    .bNumConfigurations = CFG_TUD_CONFIG_COUNT
};
...
uint8_t desc_configuration[] =
{
    ...
    TUD_HID_INOUT_DESCRIPTOR(ITF_NUM_HID, 0, HID_PROTOCOL_NONE, sizeof(desc_hid_report), CFG_TUD_EPNUM_HID, 0x80 | CFG_TUD_EPNUM_HID, CFG_TUD_HID_EP_BUFSIZE, CFG_TUD_HID_EP_INTERVAL)
};
