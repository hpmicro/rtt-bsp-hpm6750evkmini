...
/*! @brief Define events of the ADC12 module. */
 ...
 *
 * @param config A pointer to the configuration struct of "adc12_config_t".
 *
 */
 ...
 *
 * @param ptr An ADC12 peripheral base address.
 * @param config A pointer to the configuration struct of "adc12_config_t".
 ...
 *
 * @param ptr An ADC12 peripheral base address.
 * @param config A pointer to the configuration struct of "adc12_prd_config_t".
 ...
 *
 * @param ptr An ADC12 peripheral base address.
 * @param config A pointer to configuration struct of "adc12_seq_config_t".
 ...
 *
 * @param ptr An ADC12 peripheral base address.
 * @param config a pointer to configuration struct of "adc12_trig_config_t".
 ...
 *
 * @param ptr An ADC12 peripheral base address.
 * @param config A pointer to configuration struct of "adc12_dma_config_t".
 */
 ...
 *
 * @param ptr An ADC12 peripheral base address.
 * @param ch An ADC12 peripheral channel.
 ...
 *
 * @param ptr An ADC12 peripheral base address.
 * @param mask Mask value for flags to be cleared. Refer to "_adc12_status_flags".
 */
 ...
 *
 * @param ptr An ADC12 peripheral base address.
 * @param mask Mask value for interrupt events. Refer to "_adc12_interrupt_enable".
 */
 ...
 * @param ptr An ADC12 peripheral base address.
 * @param ch An ADC12 peripheral channel.
 * @param result The result of an ADC12 conversion.
 *
