...
/*! @brief Define events of the ADC16 module. */
 ...
 *
 * @param config A pointer to the configuration struct of "adc16_config_t".
 *
 */
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param config A pointer to the configuration struct of "adc16_config_t".
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param config A pointer to the configuration struct of "adc16_prd_config_t".
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param config A pointer to configuration struct of "adc16_seq_config_t".
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param config a pointer to configuration struct of "adc16_trig_config_t".
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param stop_pos The stop position offset.
 */
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param addr The start address of DMA write operation.
 */
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param config A pointer to configuration struct of "adc16_dma_config_t".
 */
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param ch An adc16 peripheral channel.
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param mask Mask value for flags to be cleared. Refer to "_adc16_status_flags".
 */
 ...
 *
 * @param ptr An adc16 peripheral base address.
 * @param mask Mask value for interrupt events. Refer to "_adc16_interrupt_enable".
 */
 ...
 * @param ptr An adc16 peripheral base address.
 * @param ch An adc16 peripheral channel.
 * @param result The result of an adc16 conversion.
 *
