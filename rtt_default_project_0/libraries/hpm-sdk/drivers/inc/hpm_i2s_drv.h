...
static inline void i2s_enable_irq(I2S_Type *ptr, uint8_t mask)
{
    ptr->CTRL |= mask;
}

static inline void i2s_disable_irq(I2S_Type *ptr, uint8_t mask)
{
    ptr->CTRL &= ~mask;
}
...
void i2s_set_mclk_div(I2S_Type *ptr, uint32_t div, bool enable_i2s_after_update);
