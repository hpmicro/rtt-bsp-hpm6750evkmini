...
typedef struct {
    ...
    __R  uint32_t DMACFG;                      /* 0x10: DMAC Configuration Regi */
    __R  uint8_t  RESERVED1[12];               /* 0x14 - 0x1F: Reserved */
    __RW uint32_t DMACTRL;                     /* 0x20: DMAC Control Register */
    __RW uint32_t CHABORT;                     /* 0x24: Channel Abort Register */
    __R  uint8_t  RESERVED2[8];                /* 0x28 - 0x2F: Reserved */
    __RW uint32_t INTSTATUS;                   /* 0x30: Interrupt Status Register */
