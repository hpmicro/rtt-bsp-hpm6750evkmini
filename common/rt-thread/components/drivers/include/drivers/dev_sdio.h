 ...
 * 2026-01-15     HPMicro       Add UHS-I related definitions
 */
...
#define  SDIO_CCCR_REV_2_00 2   /* CCCR/FBR Version 2.00 */
...
#define  SDIO_SPEED_ESDR50          0x04    /* Enable SDR50 mode */
#define  SDIO_SPEED_ESDR104         0x06    /* Enable SDR104 mode */
#define  SDIO_SPEED_EDDR50          0x08    /* Enable DDR50 mode */

#define SDIO_REG_CCCR_UHSI_SUPPORT  0x14
#define  SDIO_SPEED_SSDR50          0x01    /* Supports SDR50 mode */
#define  SDIO_SPEED_SSDR104         0x02    /* Supports SDR104 mode */
#define  SDIO_SPEED_SDDR50          0x04    /* Supports DDR50 mode */
...
struct rt_sdio_device_id
{
    ...
    rt_uint8_t   reserved;      /* Explicit padding for alignment */
