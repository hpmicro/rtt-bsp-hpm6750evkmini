 ...
 * 2025-12-19     AMPAK       add WPA3 related security mode
 */
...
#define OWE_SECURITY    0x00800000
...
typedef enum
{
    ...
    SECURITY_WPA_MIXED_PSK  = (WPA_SECURITY  | AES_ENABLED | TKIP_ENABLED ),    /* WPA PSK Security with AES & TKIP        */
    SECURITY_WPA2_WPA_PSK   = (WPA2_SECURITY | WPA_SECURITY | AES_ENABLED | TKIP_ENABLED ), /* WPA2/WPA Security with AES & TKIP  */
    SECURITY_WPA2_SHA256_PSK= (WPA2_SECURITY | AES_ENABLED | WSEC_SWFLAG),      /* WPA2 Security with SHA256  */
    SECURITY_WPA3_SAE       = (WPA3_SECURITY | AES_ENABLED),                    /* WPA3 Security with AES   */
    SECURITY_WPA3_WPA2_PSK  = (WPA3_SECURITY | WPA2_SECURITY | AES_ENABLED),    /* WPA3 WPA2 PSK Security with AES */

    SECURITY_WPA3_OWE       = (OWE_SECURITY | AES_ENABLED),                     /* WPA3 Enhanced Open (OWE) with AES security  */
    ...
    SECURITY_WPA2_WPA_ENT   = (ENTERPRISE_ENABLED | WPA2_SECURITY | WPA_SECURITY | AES_ENABLED | TKIP_ENABLED ), /**< WPA2/WPA Enterprise Security with AES & TKIP			   */

    SECURITY_WPA3_ENT       = ( ENTERPRISE_ENABLED | WPA3_SECURITY | SHA256_1X | AES_ENABLED),     /**< WPA3 Enterprise Security with AES                    */
