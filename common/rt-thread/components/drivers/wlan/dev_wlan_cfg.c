...
void rt_wlan_cfg_dump(void)
{
    ...
    for (index = 0; index < cfg_cache->num; index ++)
    {
        ...
        case SECURITY_WPA2_MIXED_PSK:
            ...
            break;
        case SECURITY_WPA2_WPA_PSK:
            security = "WPA2/1_MIXED_PSK";
            break;
        case SECURITY_WPA3_WPA2_PSK:
            security = "WPA3/2_MIXED_PSK";
            break;
        case SECURITY_WPA3_SAE:
            security = "WPA3_SAE";
            break;
        case SECURITY_WPA3_OWE:
            security = "WPA3_OWE";
            break;
        ...
        case SECURITY_WPA_TKIP_ENT:
            security = "WPA_TKIP_ENT";
            break;
        case SECURITY_WPA_AES_ENT:
            security = "WPA_AES_ENT";
            break;
        case SECURITY_WPA_MIXED_ENT:
            security = "WPA_MIXED_ENT";
            break;
        case SECURITY_WPA2_TKIP_ENT:
            security = "WPA2_TKIP_ENT";
            break;
        case SECURITY_WPA2_AES_ENT:
            security = "WPA2_AES_ENT";
            break;
        case SECURITY_WPA2_MIXED_ENT:
            security = "WPA2_MIXED_ENT";
            break;
        case SECURITY_WPA3_ENT:
            security = "WPA3_SAE_ENT";
            break;
