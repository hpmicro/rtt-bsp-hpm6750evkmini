...
#include "../ap6201bm/wifi_firmware_bcm43013c1_mfgtest.h"
#else
#include "../ap6201bm/wifi_firmware_bcm43013c1_normal.h"
#endif

#include "../ap6201bm/wifi_clm_bcm43013c1.h"
...
void wifi_chip_resource_init(void)
{
	...
	wifi_nvram_ptr     = (char*)wifi_nvram_ap6203bm;
	wifi_nvram_size    = sizeof(wifi_nvram_ap6203bm);
}