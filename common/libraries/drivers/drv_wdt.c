 ...
 * 2025-09-01     HPMicro      Revised the code, reduced repetitive codes, removed interrupt related codes
 */
...
/* Macros to reduce repetitive code */
#define WDG_DECLARE(n) rt_watchdog_t wdog##n

#define WDG_DEVICE_INIT(n) \
    {                                                                            \
      .wdog_base = HPM_WDG## n,                                                 \
      .device_name = "wdt" #n,                                                 \
      .clock_name = clock_watchdog## n,                                         \
      .wdog = &wdog## n,                                                        \
      .wdog_ctrl =                                                             \
          {                                                                    \
